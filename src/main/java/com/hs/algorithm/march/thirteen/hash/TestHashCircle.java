package com.hs.algorithm.march.thirteen.hash;

import com.hs.algorithm.march.thirteen.hash.dto.Node;
import com.hs.algorithm.march.thirteen.hash.service.IHashService;
import com.hs.algorithm.march.thirteen.hash.service.impl.HashService;
import com.hs.algorithm.march.thirteen.hash.util.ConsistentHash;

import java.util.*;

/**
 * @author heshuai
 * @title: TestHashCircle
 * @description: 一致性Hash算法代码借鉴于https://www.jianshu.com/p/528ce5cd7e8f，如有需要，请查看原作者博客，里边有更加详细的讲解
 * @date 2021年03月13日 17:12
 */
